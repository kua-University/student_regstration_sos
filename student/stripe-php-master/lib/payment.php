...
{
?>
        <h6 class="mt-4" style="margin-left: 4px;"> SOS University | I Am <b> <?php echo $row['student_name'];?> </b> </h6>
<?php
}
?>
  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <span style="float: right; font-family: Palatino Linotype, Verdana; font-size: 11pt">
              <b>Session: </b> Fall 2024 (B. Sc.)<br><b>ExamTypes: </b> Regular, Recourse, Retake</span>
          </div>
  ...
  <div class="container col-1">
    <div class="row justify-content-center">
      <script
        ...
        data-name="PAYMENT"
        data-description="Online Payment"
        data-amount="<?php echo $total; ?>" <!-- This should display the total amount -->
        data-email="<?php echo $row['email']; ?>"
        data-label="Pay Now"
        data-allow-remember-me="false"
        data-image="https://www.university-directory.eu/instlogos/BD-Premier-University-PU.jpg"
...
<footer class="text-center">
      <pre>
        <code>
          Copyright ©2011-2021 SOS University, All Rights Reserved.
          Software Section , Department of IT,SOS University (Design & Develop)
        </code>
      </pre>
</footer>
